  ...
  return (
    <>
      <main className="px-4 py-6 mt-20 md:mt-28">
        ...
        {/* <div className="bg-yellow-500 grid grid-cols-2 place-content-center md:grid-cols-4 mt-4 rounded-lg p-2 py-4 gap-2">
        ...
        <div className="bg-yellow-500 mt-4 py-4 md:py-8 rounded-lg flex flex-col md:justify-center gap-6 md:flex-row md:gap-30">
          <div className="flex flex-row items-center justify-around md:gap-30">
